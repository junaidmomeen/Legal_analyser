@echo off
REM Legal Document Analyzer - Run without Redis
REM This script runs the project without Redis dependency
...
echo [INFO] Creating environment files without Redis...

REM Create backend .env file without Redis
if not exist "backend\.env" (
    echo [INFO] Creating backend/.env...
    (
        echo # Legal Document Analyzer - Backend Environment Configuration
        echo # Running WITHOUT Redis
        echo.
        echo # =============================================================================
        ...
        echo.
        echo # =============================================================================
        echo # DATABASE & CACHING - DISABLED
        echo # =============================================================================
        echo.
        echo # Redis is disabled - using in-memory storage
        ...
        echo.
        echo # =============================================================================
        echo # RATE LIMITING - IN-MEMORY
        echo # =============================================================================
        echo.
        echo # Rate limiting settings ^(requests per minute^) - using in-memory storage
        echo RATE_LIMIT_REQUESTS_PER_MINUTE=100
        echo # RATE_LIMIT_STORAGE_URI=redis://redis:6379
        echo.
        echo # =============================================================================
        ...
        echo.
        echo # =============================================================================
        echo # CELERY SETTINGS - DISABLED
        echo # =============================================================================
        echo.
        echo # Celery is disabled - tasks run synchronously
        echo # CELERY_BROKER_URL=redis://redis:6379/0
        echo # CELERY_RESULT_BACKEND=redis://redis:6379/1
    ) > backend\.env
    echo [SUCCESS] Created backend/.env without Redis
) else (
...
echo.
echo [INFO] Starting the application without Redis...
echo.
echo 📝 Next steps:
...
REM Start the backend only (no Redis dependency)
