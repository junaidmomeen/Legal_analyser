...
class SecureErrorHandler:
    ...
    def handle_rate_limit_exceeded(self, request: Request, exc: Exception) -> JSONResponse:
    ...
    def handle_file_upload_error(self, request: Request, exc: Exception) -> JSONResponse:
